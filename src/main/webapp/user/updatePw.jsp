...
<div class="container-upPw">
		...
		<form action="updatePwProc.jsp" method="post" name="updatePwForm">
			<div class="Box-upPw">
				...
				<input type="password" id="upass" name="upass" maxlength="16" placeholder="현재 비밀번호를 입력해주세요" />
			</div>
			<div class="Box-upPw">
				<label class="Title-upPw">비밀번호 변경</label>
				<input type="password" id="newpass" name="newpass" maxlength="16" placeholder="변경될 비밀번호를 입력해주세요" />
			</div>
			<div class="Box-upPw border-none-pw">
				<label class="Title-upPw">비밀번호 확인</label>
				<input type="password" id="newpasscheck" name="newpasscheck" maxlength="16" placeholder="변경될 비밀번호를 한번 더 입력해주세요" />
			</div>
			
			<div class="submitBtnBox-upPw">
				<input type="submit" class="submitBtn-upPw" value="변경하기" />
			</div>
		</form>
